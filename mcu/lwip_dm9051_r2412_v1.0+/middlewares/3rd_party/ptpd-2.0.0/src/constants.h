...
//#define DEFAULT_TWO_STEP_FLAG         TRUE
#define DEFAULT_TWO_STEP_FLAG           TRUE //FALSE /* Transmitting only SYNC message or SYNC and FOLLOW UP */
...
//#define SLAVE_ONLY         TRUE						//modify  2023-11-14
#define SLAVE_ONLY         TRUE //FALSE						//modify  2024-11-20

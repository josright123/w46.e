...
#define ERROR(...)  { TimeInternal tmpTime; getTime(&tmpTime); printf("(E %d.%09d) ", tmpTime.seconds, tmpTime.nanoseconds); printf(__VA_ARGS__); printf("\r");} //modify 2024-11-20
...
#undef DBGVV0 //modify 2024-11-20
//#define DBGVV0(...) //modify 2024-11-20
#define DBGVV0(...)  { TimeInternal tmpTime; getTime(&tmpTime); printf("(VV0 %d.%09d) ", tmpTime.seconds, tmpTime.nanoseconds); printf(__VA_ARGS__); printf("\r");} //modify 2024-11-20

#undef DBGVV //modify 2024-11-20
#define DBGVV(...) { printf("(V) " __VA_ARGS__); printf("\r");} //modify 2024-11-20

//#define PTPD_DBGV  //modify 2023-10-30
#ifdef PTPD_DBGV
#define PTPD_DBG
#define PTPD_ERR
#define DBGV(...)  { TimeInternal tmpTime; getTime(&tmpTime); printf("(d %d.%09d) ", tmpTime.seconds, tmpTime.nanoseconds); printf(__VA_ARGS__); printf("\r");} //modify 2024-11-20
#else
#define DBGV(...)
//#define DBGV(...)  { TimeInternal tmpTime; getTime(&tmpTime); printf("(d %d.%09d) ", tmpTime.seconds, tmpTime.nanoseconds); printf(__VA_ARGS__); printf("\r");} //modify 2024-11-20
#endif
...
#define DBG(...)  { TimeInternal tmpTime; getTime(&tmpTime); printf("(D %d.%09d) ", tmpTime.seconds, tmpTime.nanoseconds); printf(__VA_ARGS__); printf("\r");} //modify 2024-11-20
#else
//#define DBG(...)
#define DBG(...)  { TimeInternal tmpTime; getTime(&tmpTime); printf("(D %d.%09d) ", tmpTime.seconds, tmpTime.nanoseconds); printf(__VA_ARGS__); printf("\r");} //modify 2024-11-20
#endif

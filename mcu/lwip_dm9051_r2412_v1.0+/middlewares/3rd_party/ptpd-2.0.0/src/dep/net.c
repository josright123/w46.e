...
DBGVV("J-igmp_joingroup, interfaceAddr %u.%u.%u.%u to netAddr %u.%u.%u.%u (join general)\n",
		interfaceAddr.addr & 0xff, (interfaceAddr.addr >> 8) & 0xff,
		(interfaceAddr.addr >> 16) & 0xff, (interfaceAddr.addr >> 24) & 0xff,
		netAddr.addr & 0xff, (netAddr.addr >> 8) & 0xff,
		(netAddr.addr >> 16) & 0xff, (netAddr.addr >> 24) & 0xff);
...
DBGVV("J-igmp_joingroup, interfaceAddr %u.%u.%u.%u to netAddr %u.%u.%u.%u (join peer)\n",
		interfaceAddr.addr & 0xff, (interfaceAddr.addr >> 8) & 0xff,
		(interfaceAddr.addr >> 16) & 0xff, (interfaceAddr.addr >> 24) & 0xff,
		netAddr.addr & 0xff, (netAddr.addr >> 8) & 0xff,
		(netAddr.addr >> 16) & 0xff, (netAddr.addr >> 24) & 0xff);
...
DBGVV("J-netRecvEventCallback: outgoing multicast %u.%u.%u.%u udp_recv(netPath->eventPcb, ...\n",
		netPath->eventPcb->mcast_ip4.addr & 0xff, (netPath->eventPcb->mcast_ip4.addr >> 8) & 0xff,
		(netPath->eventPcb->mcast_ip4.addr >> 16) & 0xff, (netPath->eventPcb->mcast_ip4.addr >> 24) & 0xff);
...
DBGVV("J-netRecvGeneralCallback: outgoing multicast %u.%u.%u.%u udp_recv(netPath->generalPcb, ...\n",
		netPath->generalPcb->mcast_ip4.addr & 0xff, (netPath->generalPcb->mcast_ip4.addr >> 8) & 0xff,
		(netPath->generalPcb->mcast_ip4.addr >> 16) & 0xff, (netPath->generalPcb->mcast_ip4.addr >> 24) & 0xff);
